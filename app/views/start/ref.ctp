<div class="grid_16">
    <h2 id="page-heading">Germany > North Rhine-Westphalia > Cologne</h2>
</div>
<div class="clear"></div>
<div class="grid_4">
    <div class="box">
...
<div class="grid_4">
    ...
    <div class="box">
        <h2>
            <a href="#" id="toggle-ajax" class="hidden"><img src="/hc3/img/ajax-loader.gif" id="loading" alt="Loading" />
    Ajax Content
</a>
        </h2>
...
<div class="grid_5">
    <div class="box">
        <h2>
            <a href="#" id="toggle-search">Quick Search</a>
        </h2>
